...
public class MuskratW7 : MonoBehaviour
{
    ...
    private void MoveOrbitMode()
    {
        ...
        bool _running = Mathf.Abs(forward) != 0.0f;
    ...
    private void MoveNormal()
    {
        ...
        bool _flying = Mathf.Abs(_rigidbody.linearVelocity.y) > 0.2f;

        _animator.SetBool("flying", _flying);

        bool _running = Mathf.Abs(_rigidbody.linearVelocity.x) != 0.0f;
    ...
    // :DDDDDDDDDDDD D:::::::::::::::::::::::: 0: 0:< :< :< :< :< ;,( WAUUUGHHHHH WAUGHGH 
